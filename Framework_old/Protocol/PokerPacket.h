...
public:
	...
	int												m_nInPlayAmount;				// [OUT] in-play amount (Real money tables only).
	int												m_nBalance;						// [OUT] Balance.
	int												m_nPlayBalance;					// [OUT] Play-money balance.
	int												m_nBadBeatJackpotAmount;		// [OUT] BadBeat jackpot amount.
...
public:
	...
	std::string								m_sUserName;			// [OUT] User name.
	int									m_nBalance;				// [OUT] User's balance.
	int									m_nAmountMin;			// [OUT] Min amount to add.
	int									m_nAmountMax;			// [OUT] Max amount to add.
...
public:
	...
	int						m_nChipAmount;		// [IN]	Add chip amount.
...
public:
	int						m_nTableId;			// [IN] Table id.
	int						m_nAmount;			// [IN] Add chips amount.
	bool					m_bPrepareToAdd;	// [IN] Prepare to add chips.
	char					m_cSeat;			// [OUT] Seat index.
	int						m_nBalance;			// [OUT] Balance amount.
	int						m_nMin;				// [OUT] Min amount
	int						m_nMax;				// [OUT] Max amount
...
public:
	int			m_nTableId;		// [IN] table id.
	std::string		m_sUserName;	// [IN]	User name. {Isn't nacessary}
...
public:
	...
	int										m_nAmount;					// [IN]	Action amount.
	char									m_cSeat;					// [IN] Seat index.
	...
	int										m_nBalance;					// [OUT] Seat balance amount.
	int										m_nPotAmount;				// [OUT] Pot amount of seat.
	int										m_nSeatTotalPot;			// [OUT] Seat total pot amount.
	int										m_nTotalPot;				// [OUT] Total pot amount of table.
...
public:
	...
	int		m_nAmountMin;		// Amount min.
	int		m_nAmountMax;		// Amount max.
...
public:
	...
	char								m_cSeat;			// [OUT] Seat index.
	int									m_nPotAmount;		// [OUT] Pot amount.
	int									m_nTotalPotAmount;	// [OUT] Total pot amount.
	int									m_nBalance;			// [OUT] Balance amount.
...
public:
	...
	EnumerableObject<PokerSeatAmountInfo>	m_seatAmounts;	// [OUT] List of seat amounts.
	int									m_nTotalPotAmount;	// [OUT] Total pot amount.
	int									m_nMainPotAmount;	// [OUT] Main pot amount.
	DateTime							m_dtAction;			// [OUT] Action time. (Server time)
...
public:
	...
	EnumerableObject<PokerHandCards>		m_handCards;		// [OUT] Hand cards.
	DateTime								m_dtAction;			// [OUT] Action time. (Server time) 
	WORD									m_wRakeAmount;		// [OUT] Rake amount.
...
public:
	...
	int										m_nMainPotAmount;		// [OUT] Main pot amount (Rake amount is included).
	int										m_nTotalPotAmount;		// [OUT] Total pot amount.
...
public:
	int									m_nTableId;			// [IN] Table Id.
	char								m_cSeat;			// [IN] Seat index.
	bool								m_bPostBB;			// [IN] PostBB = true, PostSB = false.
...
public:
	...
	int						m_nBalanceFrom;		// [OUT] Balance of account from.
	int						m_nBalanceTo;		// [OUT] Balance of account to.
...
public:
	int						m_nPlayMoneyAmount;		// [OUT] Playmoney amount after performing reset.
...
public:
	int						m_nBalance;				// [OUT] Balance amount.
	int						m_nPlayMoneyAmount;		// [OUT] Playmoney amount.
...
public:
	...
	int			m_nBBAmount;		// Small blind amount.
...
public:
	std::string								m_sTournamentID;	// [IN] Tournament ID. ex: T0000078
...
public:
	...
	int										m_nBalance;			// [OUT] Balance amount.
	double									m_dPoint;			// [OUT] Points amount.
	char									m_cTicketCt;		// [OUT] Ticket count.
...
public:
	...
	*/
	...
	int									m_nSmallBlind_Next;			// [OUT] Smallblind of next level.
	int									m_nBigBlind_Next;			// [OUT] Bigblind of next level.
	int									m_nAnte_Next;				// [OUT] Ante of next level.
...
public:
	...
	int						m_nSmallBlind;		// [OUT] Smallblind amount.
	int						m_nBigBlind;		// [OUT] Bigblind amount.
	int						m_nAnte;			// [OUT] Ante amount.

	int						m_nSmallBlind_Next;	// [OUT] Smallblind amount of next level.
	int						m_nBigBlind_Next;	// [OUT] Bigblind amount of next level.
	int						m_nAnte_Next;		// [OUT] Ante amount of next level.
...
enum TournamentTableWaitingState {WaitingForBreak = 1, WaitingForOtherTables = 2, WaitingForPlayersToMakeRebuy = 3/*Rebuy or buyin*/};
...
public:
	int						m_nTournamentId;		// [OUT] Tournament id.
	int						m_nTableId;				// [OUT] Table id.
	char					m_cWaitFor;				// [OUT] One of the TournamentTableWaitingState constants.
...
public:
	...
	int						m_nAmountWon;			// [OUT] Amount won or refunded (When cancel flag is set).
...
public:
	int						m_nTournamentId;	// [IN] Tournament id.
	int						m_nTableId;			// [IN] Table id.
	int						m_nChipsAmount;		// [OUT] Chips amount.
	int						m_nBalanceNew;		// [OUT] Balance amount remaining.
