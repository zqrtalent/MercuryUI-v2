...
BEGIN_DECLARE_VAR(LoginPacket, BasePacket)
	...
	DECLARE_VAR(_T("Balance"),			_T(""), VariableType::VT_Int32, offsetof(LoginPacket,m_nBalance), false, false, false)
	DECLARE_VAR(_T("PlayBalance"),		_T(""), VariableType::VT_Int32, offsetof(LoginPacket,m_nPlayBalance), false, false, false)
