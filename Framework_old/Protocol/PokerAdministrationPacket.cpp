...
BEGIN_DECLARE_VAR(PokerGameTableInfoObject, Serializable)
	...
	DECLARE_VAR(_T("MinBet"),					_T(""), VariableType::VT_Float, offsetof(PokerGameTableInfoObject,m_fMinBet), false, false, false)
	DECLARE_VAR(_T("MaxBet"),					_T(""), VariableType::VT_Float, offsetof(PokerGameTableInfoObject,m_fMaxBet), false, false, false)
...
BEGIN_DECLARE_VAR(CreateGameTableObject, Serializable)
	...
	DECLARE_VAR(_T("MinBet"),						_T(""), VariableType::VT_Float, offsetof(CreateGameTableObject,m_fMinBet), false, false, false)
	DECLARE_VAR(_T("MaxBet"),						_T(""), VariableType::VT_Float, offsetof(CreateGameTableObject,m_fMaxBet), false, false, false)
