...
bool
SSLSocketContext::Connect(const TCHAR* pszIp, int nPort, bool bKeepAlive /*= false*/, int nKeepAliveTime /*= 0*/, int nKeepAliveInterval /*= 0*/, SOCKET* pCopySocket /*= NULL*/, HANDLE hConnectEvent /*= NULL*/){
