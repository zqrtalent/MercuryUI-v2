...
BOOL
Image::Save(const _string sImageFile){
	return FALSE;
	}
...
BOOL
Image::BitmapOnBitmap(BITMAP* pDestBmImage, int xDest, int yDest, BITMAP* pSrcBmImage, int xSrc, int ySrc, int nWidthSrc, int nHeightSrc,
...
BOOL
Image::BitmapOnBitmap(int xDest, int yDest, Image* pSrcImage, int xSrc, int ySrc, int nWidthSrc, int nHeightSrc,
						int nDrawWidth, int nDrawHeight, BOOL bAlpha /*= FALSE*/, BYTE btAlpha /*= 255*/,
                      BOOL bIgnoreFullAlphaPixel /*= FALSE*/, bool bDontAffectAlphaChannel /*= false*/)
	{
...
Image*
Image::CombineImages(Image* pImageBg, Image* pImageFg, bool bFgIsAlphaChannelImage, int nCombinedImageBPP /*= 24*/, _Rect rcForeground /*= Rect(0, 0, 0, 0)*/){
    /*
