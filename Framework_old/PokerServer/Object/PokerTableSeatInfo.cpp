...
//	DECLARE_VAR(_T("Offline"), _T(""),			VariableType::VT_Bool, offsetof(PokerTableSeatInfo,m_bOffline), false, false, false)
	...
	DECLARE_VAR(_T("Balance"), _T(""),			VariableType::VT_Int32, offsetof(PokerTableSeatInfo,m_nBalance), false, false, false)
	DECLARE_VAR(_T("PotAmount"), _T(""),		VariableType::VT_Int32, offsetof(PokerTableSeatInfo,m_nPotAmount), false, false, false)
	DECLARE_VAR(_T("PotAmountTotal"), _T(""),	VariableType::VT_Int32, offsetof(PokerTableSeatInfo,m_nPotAmountTotal), false, false, false)
...
PokerTableSeatInfo::Copy(Serializable* pInto){
	...
	if( bRet ){
		...
		pSeatInfoInto->SetSession	(m_pSes);
		// Copy offline flag.
...
#ifdef _SERVER
BOOL
PokerTableSeatInfo::Serialize(GrowableMemory* pMem){
...
void
PokerTableSeatInfo::SetSession(Session* pSes){
