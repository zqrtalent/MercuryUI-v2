...
public:
	...
	int				m_nWonAmount;		// [OUT] Won amount (Without rake).
...
public:
	...
	int										m_nWonAmount;			// [OUT] Won amount (Without rake). 
	int										m_nReturnBackAmount;	// [OUT] Return back amount.
	int										m_nBalance;				// [OUT] Balance amount (Won or return back amount are not included.).
