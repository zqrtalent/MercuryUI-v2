...
BEGIN_DECLARE_VAR(PokerHandWinnerInfo, Serializable)
	...
	DECLARE_VAR(_T("WonAmount"),			_T(""), VariableType::VT_Int32, offsetof(PokerHandWinnerInfo,m_nWonAmount), false, false, false)
	DECLARE_VAR(_T("ReturnBackAmount"),		_T(""), VariableType::VT_Int32, offsetof(PokerHandWinnerInfo,m_nReturnBackAmount), false, false, false)
	DECLARE_VAR(_T("Balance"),				_T(""), VariableType::VT_Int32, offsetof(PokerHandWinnerInfo,m_nBalance), false, false, false)
...
BEGIN_DECLARE_VAR(PokerWonAmountDetail, Serializable)
	...
	DECLARE_VAR(_T("WonAmount"),			_T(""), VariableType::VT_Int32, offsetof(PokerWonAmountDetail,m_nWonAmount), false, false, false)
	DECLARE_VAR(_T("RakeAmount"),			_T(""), VariableType::VT_Int16, offsetof(PokerWonAmountDetail,m_wRakeAmount), false, false, false)
