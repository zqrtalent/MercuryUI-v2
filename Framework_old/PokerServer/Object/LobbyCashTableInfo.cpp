...
BEGIN_DECLARE_VAR(LobbyCashTablePlayerInfo, Serializable)
	...
	DECLARE_VAR(_T("SeatAmount"),				_T(""),		VariableType::VT_Int32, offsetof(LobbyCashTablePlayerInfo,m_nSeatAmount), false, false, false)
...
BEGIN_DECLARE_VAR(LobbyCashTableDynamicInfo, Serializable)
	...
	DECLARE_VAR(_T("AvgPotAmount"),					_T("AVG_POT_AMOUNT"),		VariableType::VT_Int32, offsetof(LobbyCashTableDynamicInfo,m_nAvgPotAmount), false, false, false)
