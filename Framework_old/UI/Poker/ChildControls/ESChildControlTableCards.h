...
public:
	...
	Rect			GetCardRect			(int nCardIndex);
...
protected:
	...
	virtual std::string	GetControlDefaultName	(){return _T("_tableCards");};
...
protected:
	...
	Size			m_szCard;				// Default card dimensions.
	Size			m_szCardCurrent;		// Current card dimensions.
