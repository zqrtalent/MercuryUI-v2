...
__inline void 
CGridCtrl::SetColors(COLORREF ColorFrame, COLORREF ColorNormalFill, COLORREF ColorSelFill, COLORREF ColorBtnFill, COLORREF ColorNormalText, COLORREF ColorSelText) 
	{
...
__inline void 
CGridCtrl::SetCellSelectionMode(BOOL bMode /*= TRUE*/)
	{
	m_bCellMode = bMode;
	}
