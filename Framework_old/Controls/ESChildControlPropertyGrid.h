...
typedef void (__cdecl *DrawPropertyGridItemMethod) (ESPropertyGridItem*, _DC*, _Rect*, _Rect*, COLORREF, Font*);
...
protected:
	...
	bool					DrawPropertyGridItemByType	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	// Property grid item drawing methods by its type.
	static void				DrawPropertyGridItem_String	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Numeric(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Enum	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Color	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Image	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Size	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Point	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Rect	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Font	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
	static void				DrawPropertyGridItem_Binary	(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont);
...
protected:
	Font*					m_pFontParentItem;
	Font*					m_pFontChildItem;
	Font*					m_pFontChildItemValue;

	Font					m_fontParentItem;
	Font					m_fontChildItem;
	Font					m_fontChildItemValue;
