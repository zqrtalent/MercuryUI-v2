...
ESChildControlLabel::ESChildControlLabel(){
	...
	m_fillMode			.Add(_T("None"),				FillMode::FillMode_None);
	m_fillMode			.Add(_T("Color"),				FillMode::FillMode_Color);
	m_fillMode			.Add(_T("CentredImage"),		FillMode::FillMode_CentredImage);
	m_fillMode			.Add(_T("StretchImage"),		FillMode::FillMode_StretchImage);
	m_fillMode			.Add(_T("RepeatedImage"),		FillMode::FillMode_RepeatedImage);
	m_fillMode			.Add(_T("OmitBorderedImage"),	FillMode::FillMode_OmitBorderedImage);
