...
MercuryBaseViewInfo::MercuryBaseViewInfo(){
	...
	m_bgFillMode	.Add(_T("None"),				FillMode::FillMode_None);
	m_bgFillMode	.Add(_T("Color"),				FillMode::FillMode_Color);
	m_bgFillMode	.Add(_T("CentredImage"),		FillMode::FillMode_CentredImage);
	m_bgFillMode	.Add(_T("StretchImage"),		FillMode::FillMode_StretchImage);
	m_bgFillMode	.Add(_T("RepeatedImage"),		FillMode::FillMode_RepeatedImage);
	m_bgFillMode	.Add(_T("OmitBorderedImage"),	FillMode::FillMode_OmitBorderedImage);
...
BEGIN_DECLARE_VAR(MercuryBaseViewInfo, Serializable)
	...
	DECLARE_VAR(_T("Default _Size"),				_T(""), VariableType::VT_Size, offsetof(MercuryBaseViewInfo,m_szDefault), false, false, false)
	DECLARE_VAR(_T("Min _Size"),					_T(""), VariableType::VT_Size, offsetof(MercuryBaseViewInfo,m_szMin), false, false, false)
	DECLARE_VAR(_T("Max _Size"),					_T(""), VariableType::VT_Size, offsetof(MercuryBaseViewInfo,m_szMax), false, false, false)
	...
	DECLARE_VAR(_T("_SizeBoxImage"),				_T(""), VariableType::VT_Image, offsetof(MercuryBaseViewInfo,m_sizeBoxImage), false, false, false)
