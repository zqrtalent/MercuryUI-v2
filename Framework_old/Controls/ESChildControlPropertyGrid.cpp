		...
		case VariableType::VT_Font:
			{
				...
				pFontBox->SetFont				(((Font*)lpValuePtr), false);
...
ESChildControlPropertyGrid::OnPaintClient(_DC *pDC, _Rect* pRectDC, _Rect* pRectClient){
	...
	Image*				pImageSignExpanded	= &pGUI->treeGrid.m_imageExpandSign;
	Image*				pImageSignCollapsed	= &pGUI->treeGrid.m_imageCollapseSign;
...
bool
ESChildControlPropertyGrid::DrawPropertyGridItemByType(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont ){
...
void
ESChildControlPropertyGrid::DrawPropertyGridItem_String(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
...
void
ESChildControlPropertyGrid::DrawPropertyGridItem_Numeric(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	_Rect	rcInvalid = *pRectDC&*pItemRectDC;
	_string sValue;
	_Size	szText(0, 0);
...
void
ESChildControlPropertyGrid::DrawPropertyGridItem_Enum(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	_Rect	rcInvalid = *pRectDC&*pItemRectDC;
	_string sValue;
	_Size	szText(0, 0);
...
void
ESChildControlPropertyGrid::DrawPropertyGridItem_Color(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	_Rect	rcInvalid	= *pRectDC&*pItemRectDC;
	_string sValue;
	_Size	szText(0, 0);
...
void
ESChildControlPropertyGrid::DrawPropertyGridItem_Image(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	_Rect	rcInvalid	= *pRectDC&*pItemRectDC;
	_string sValue;
	_Size	szText(0, 0);

	Image* pImage	= (Image*)GetPropertyValuePtr(pItem);
	if( !pImage ) return;
	if( pImage->IsNull() )
...
void
ESChildControlPropertyGrid::DrawPropertyGridItem_Size(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	DrawPropertyGridItem_String(pItem, pDC, pRectDC, pItemRectDC, crText, pFont);
	}

void
ESChildControlPropertyGrid::DrawPropertyGridItem_Point(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	DrawPropertyGridItem_String(pItem, pDC, pRectDC, pItemRectDC, crText, pFont);
	}

void
ESChildControlPropertyGrid::DrawPropertyGridItem_Rect(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	_Rect	rcInvalid = *pRectDC&*pItemRectDC;
	_string sValue;
	_Size	szText(0, 0);
...
void
ESChildControlPropertyGrid::DrawPropertyGridItem_Font(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	_Rect	rcInvalid	= *pRectDC&*pItemRectDC;
	_string sValue;
	_Size	szText(0, 0);

	Font*	pFontValue	= (Font*)GetPropertyValuePtr(pItem);
...
void
ESChildControlPropertyGrid::DrawPropertyGridItem_Binary(ESPropertyGridItem* pItem, _DC* pDC, _Rect* pRectDC, _Rect* pItemRectDC, COLORREF crText, Font* pFont){
	DrawPropertyGridItem_String(pItem, pDC, pRectDC, pItemRectDC, crText, pFont);
	}
...
ESChildControlPropertyGrid::ModifyPropertyGridItem_Image(ESPropertyGridItem* pItem, ESChildControl* pControl){
	...
	Image*					pImageOld		= (Image*)GetPropertyValuePtr(pItem);
	if( !pImageOld ){
		ASSERT(FALSE);
		return;
		}
	...
	Image*	pImageNew = Image::LoadImage(sImageFile, -1, -1, false);
	if( pImageNew ){
		if( !pImageNew->IsNull() )
...
ESChildControlPropertyGrid::ModifyPropertyGridItem_Font(ESPropertyGridItem* pItem, ESChildControl* pControl){
	...
	Font*						pFont			= pFontControl->GetFont();
	Font*						pFontVal		= (Font*)GetPropertyValuePtr(pItem);
	if( !pFontVal ){
		ASSERT(FALSE);
		return;
		}
...
ESChildControlPropertyGrid::OnImageClear(ESChildTextBox* pSender, ChildControlEventCode eventCode, int nParam /*= 0*/){
	...
	Image* pImgValue = (Image*)GetPropertyValuePtr(m_pSelectedItem);
