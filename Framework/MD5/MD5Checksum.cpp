...
RETURNS:		_String : the hexadecimal MD5 checksum for the specified file
...
NOTES:			Provides an interface to the CMD5Checksum class. 'strFilePath' name should 
				...
				exception.
*****************************************************************************************/
_String CMD5Checksum::GetMD5(const _String& strFilePath)
{
...
*****************************************************************************************/
_String CMD5Checksum::GetMD5(CFile& File)
{
	try
	{
...
RETURNS:		_String : the hexadecimal MD5 checksum for the specified data
...
NOTES:			Provides an interface to the CMD5Checksum class. Any data that can
				...
				function. Typically, _String and char arrays will be checksumed, 
...
*****************************************************************************************/
_String CMD5Checksum::GetMD5(BYTE* pBuf, UINT nLength)
{
	//entry invariants
...
RETURNS:		_String : the final hexadecimal MD5 checksum result 
ARGUMENTS:		None
