...
int		__stdcall 
CountMembersInChain(void* pFirstElem, const long nNextPointerOffset){
	int nCt = 0;
	while( pFirstElem ){
		void* pNextPointer	= (void*)((INT32*)((INT32)(pFirstElem) + nNextPointerOffset))[0];
		pFirstElem			= pNextPointer;
...
void*	__stdcall 
LastMember(void* pFirstElem, const long nNextPointerOffset){
	void* pPrevElem = NULL;
	void* pNextPointer = NULL;
	while( pFirstElem ){
		pNextPointer	= (void*)((INT32*)((INT32)(pFirstElem) + nNextPointerOffset))[0];
		pPrevElem		= pFirstElem;
		pFirstElem		= pNextPointer;
		}
	return pPrevElem;
	}
...
void	__stdcall 
SetPointersCount(void* pFirstElem, const long nNextPointerOffset, int nCount){
	int nCt = 0;
	while( pFirstElem ){
		void* pNextPointer	= (void*)((INT32*)((INT32)(pFirstElem) + nNextPointerOffset))[0];
		pFirstElem			= pNextPointer;
		...
		if( nCt == nCount ){
			...
			pNextPointer = (void*)((INT32*)((INT32)(pFirstElem) + nNextPointerOffset))[0];
			if( pNextPointer != NULL ){
				FreePointersChain(pNextPointer, nNextPointerOffset);
				// Empty next pointer.
				*(INT32*)((INT32)(pFirstElem) + nNextPointerOffset) = 0;
				}
			break;
			}
		}
