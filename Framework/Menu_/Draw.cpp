...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
CBufferDC::CBufferDC (HDC hDestDC, const _Rect& rcPaint) : m_hDestDC (hDestDC)
{
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
FontDC::FontDC (HDC hDC, LPCTSTR sFaceName, int nFontHeight, COLORREF crText)
...
/////////////////////////////////////////////////////////////////////////////
FontDC::FontDC (HDC hDC, BYTE nStockFont, COLORREF crText)
        : m_hDC (hDC), m_hFont (NULL), m_hDefFont (NULL), m_crTextOld (CLR_NONE)
{
    *this = nStockFont;
...
/////////////////////////////////////////////////////////////////////////////
FontDC::FontDC (HDC hDC, HFONT hFont, COLORREF crText)
        : m_hDC (hDC), m_hFont (NULL), m_hDefFont (NULL), m_crTextOld (CLR_NONE)
{
    *this = hFont;
...
/////////////////////////////////////////////////////////////////////////////
const FontDC& FontDC::operator = (LPCTSTR sFaceName){
    LOGFONT lf;
...
/////////////////////////////////////////////////////////////////////////////
const FontDC& FontDC::operator = (BYTE nStockFont)
{
    if ( m_hDefFont != NULL )
    {
        ::SelectObject (m_hDC, m_hDefFont);
...
/////////////////////////////////////////////////////////////////////////////
const FontDC& FontDC::operator = (HFONT hFont)
{
    if ( m_hDefFont != NULL )
    {
        ::SelectObject (m_hDC, m_hDefFont);
...
/////////////////////////////////////////////////////////////////////////////
const FontDC& FontDC::operator = (COLORREF crText)
{
    if ( m_crTextOld == CLR_NONE )
    {
...
/////////////////////////////////////////////////////////////////////////////
void 
CDrawButton::Draw (CDC* pDC, DWORD wStyle) const{
    ...
    if ( DB_GETTYPE(wStyle) == DB_UPDOWN )
    {
        if ( !DB_ISPRESSED2(wStyle) )
        {
            if ( DB_ISFLAT(wStyle) )
            {
                _Rect rcBtn (rc.left, rc.top, rc.right, (rc.top+rc.bottom)/2+1);
            ...
            {
                _Rect rcBtn (rc.left, rc.top, rc.right, (rc.top+rc.bottom)/2);
        ...
        if ( !DB_ISPRESSED1(wStyle) )
        {
            if ( DB_ISFLAT(wStyle) )
            {
                _Rect rcBtn (rc.left, (rc.top+rc.bottom)/2/*+rc.Height()%2*/, rc.right, rc.bottom);
    ...
    else
    {
        ...
        switch ( DB_GETTYPE(wStyle) )
        {
            case DB_3POINTS:
                ...
                pDC->DrawText (_T("..."), 3, _Rect(rc.left + ((DB_ISPRESSED(wStyle)||DB_ISFLAT(wStyle)) ? 2 : 1),
...
/////////////////////////////////////////////////////////////////////////////
void CDrawButton::CheckForMouseOver (CWnd* pWnd, _Point pt)
{
