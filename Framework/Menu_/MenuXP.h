...
public:
	...
	static void		UpdateMenuItemStrings	(HMENU hMenu, bool bMenuBar);
...
// Attributes
protected:
    static CMap <int, int, _String, _String&> ms_sCaptions;
    static CMap <HMENU, HMENU, _String, _String&> ms_sSubMenuCaptions;
