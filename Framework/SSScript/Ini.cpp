...
CIni::~CIni()
{
	...
	if (m_pszPathNameW != NULL)
		delete [] m_pszPathNameW;
}
...
void 
CIni::SetPathName(LPCTSTR lpPathName)
	{
	if (lpPathName == NULL){
		if (m_pszPathName != NULL)
			*m_pszPathName = _T('\0');
...
void 
CIni::SetPathNameW(LPCWSTR lpPathName)
	{
	if (lpPathName == NULL)
		{
		if (m_pszPathNameW != NULL)
		...
		if (m_pszPathNameW != NULL)
			delete [] m_pszPathNameW;
		m_pszPathNameW = _wcsdup(lpPathName);
		}
	}

// Retrieve ini file path name
DWORD CIni::GetPathName(LPTSTR lpBuffer, DWORD dwBufSize)
{
	*lpBuffer = _T('\0');
	DWORD dwLen = 0;
	if (lpBuffer != NULL)
...
// may be truncated.
DWORD CIni::GetString(LPCTSTR lpSection, LPCTSTR lpKey, LPTSTR lpBuffer, DWORD dwBufSize, LPCTSTR lpDefault)
{
	if (lpBuffer != NULL)
		*lpBuffer = _T('\0');
...
#ifdef __AFXWIN_H__
CString CIni::GetString(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpDefault)
{
	LPTSTR psz = __GetStringDynamic(lpSection, lpKey, lpDefault);
	CString str(psz);
	delete [] psz;
...
BOOL CIni::WriteString(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpValue)
{
	if (lpSection == NULL || lpKey == NULL)
		return FALSE;
	return WritePrivateProfileString(lpSection, lpKey, lpValue == NULL ? _T("") : lpValue);
}

// Read a string value from the ini file, append another string after it and then write it
// back to the ini file
BOOL CIni::AppendString(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpString)
{
	if (lpString == NULL)
		return FALSE;
...
DWORD CIni::GetArray(LPCTSTR lpSection, LPCTSTR lpKey, LPTSTR lpBuffer, DWORD dwBufSize, LPCTSTR lpDelimiter, BOOL bTrimString)
{
	if (lpBuffer != NULL)
		*lpBuffer = _T('\0');
...
#ifdef __AFXWIN_H__
void CIni::GetArray(LPCTSTR lpSection, LPCTSTR lpKey, CStringArray *pArray, LPCTSTR lpDelimiter, BOOL bTrimString)
{
	if (pArray != NULL)
		pArray->RemoveAll();
...
#ifdef __AFXWIN_H__
BOOL CIni::WriteArray(LPCTSTR lpSection, LPCTSTR lpKey, const CStringArray *pArray, int nWriteCount, LPCTSTR lpDelimiter)
{
	if (pArray == NULL)
		return FALSE;
...
int CIni::GetInt(LPCTSTR lpSection, LPCTSTR lpKey, int nDefault, int nBase)
{
...
UINT CIni::GetUInt(LPCTSTR lpSection, LPCTSTR lpKey, UINT nDefault, int nBase)
{
	TCHAR sz[DEF_PROFILE_NUM_LEN + 1] = _T("");
	GetString(lpSection, lpKey, sz, DEF_PROFILE_NUM_LEN);
...
// Get a boolean value
BOOL CIni::GetBool(LPCTSTR lpSection, LPCTSTR lpKey, BOOL bDefault)
{
	TCHAR sz[DEF_PROFILE_NUM_LEN + 1] = _T("");
	GetString(lpSection, lpKey, sz, DEF_PROFILE_NUM_LEN);
...
double CIni::GetDouble(LPCTSTR lpSection, LPCTSTR lpKey, double fDefault)
{
	TCHAR sz[DEF_PROFILE_NUM_LEN + 1] = _T("");
	GetString(lpSection, lpKey, sz, DEF_PROFILE_NUM_LEN);
...
BOOL CIni::WriteInt(LPCTSTR lpSection, LPCTSTR lpKey, int nValue, int nBase)
{
...
BOOL CIni::WriteUInt(LPCTSTR lpSection, LPCTSTR lpKey, UINT nValue, int nBase)
{
	TCHAR szValue[DEF_PROFILE_NUM_LEN + 1] = _T("");
...
BOOL CIni::WriteDouble(LPCTSTR lpSection, LPCTSTR lpKey, double fValue, int nPrecision)
{
	TCHAR szFmt[16] = _T("%f");
...
BOOL CIni::IncreaseDouble(LPCTSTR lpSection, LPCTSTR lpKey, double fIncrease, int nPrecision)
{
...
BOOL CIni::WriteBool(LPCTSTR lpSection, LPCTSTR lpKey, BOOL bValue)
{
...
// then write it back
BOOL CIni::InvertBool(LPCTSTR lpSection, LPCTSTR lpKey)
{
...
BOOL CIni::IncreaseInt(LPCTSTR lpSection, LPCTSTR lpKey, int nIncrease, int nBase)
{
...
BOOL CIni::IncreaseUInt(LPCTSTR lpSection, LPCTSTR lpKey, UINT nIncrease, int nBase)
{
...
TCHAR CIni::GetChar(LPCTSTR lpSection, LPCTSTR lpKey, TCHAR cDefault)
{
	TCHAR sz[2] = _T("");
...
BOOL CIni::WriteChar(LPCTSTR lpSection, LPCTSTR lpKey, TCHAR c)
{
	TCHAR sz[2] = { c, _T('\0') };
...
DWORD CIni::GetDataBlock(LPCTSTR lpSection, LPCTSTR lpKey, LPVOID lpBuffer, DWORD dwBufSize, DWORD dwOffset)
{
	LPTSTR psz = __GetStringDynamic(lpSection, lpKey);
...
BOOL CIni::WriteDataBlock(LPCTSTR lpSection, LPCTSTR lpKey, LPCVOID lpData, DWORD dwDataSize)
{
...
BOOL CIni::AppendDataBlock(LPCTSTR lpSection, LPCTSTR lpKey, LPCVOID lpData, DWORD dwDataSize)
{
	const BYTE* lpb = (const BYTE*)lpData;
	if (lpb == NULL)
		return FALSE;
...
// Get a POINT value
POINT CIni::GetPoint(LPCTSTR lpSection, LPCTSTR lpKey, POINT ptDefault)
{
	POINT pt;
...
// Get a RECT value
RECT CIni::GetRect(LPCTSTR lpSection, LPCTSTR lpKey, RECT rcDefault)
{
	RECT rc;
...
BOOL CIni::WritePoint(LPCTSTR lpSection, LPCTSTR lpKey, POINT pt)
{
	return WriteDataBlock(lpSection, lpKey, &pt, sizeof(POINT));
}

// Write a RECT to the ini file
BOOL CIni::WriteRect(LPCTSTR lpSection, LPCTSTR lpKey, RECT rc)
{
...
DWORD CIni::GetKeyLines(LPCTSTR lpSection, LPTSTR lpBuffer, DWORD dwBufSize)
{
	if (lpBuffer != NULL)
		*lpBuffer = _T('\0');
	...
	if (lpBuffer == NULL)
	{
		...
		DWORD dwCopied = GetPrivateProfileSection(lpSection, psz, dwLen);
		...
		while (dwCopied + 2 >= dwLen)
		{
			...
			dwCopied = GetPrivateProfileSection(lpSection, psz, dwLen);
		}
	...
	{
		return GetPrivateProfileSection(lpSection, lpBuffer, dwBufSize);
	}
}

// Retrieve a list of key names of the specified section
DWORD CIni::GetKeyNames(LPCTSTR lpSection, LPTSTR lpBuffer, DWORD dwBufSize)
{
	if (lpBuffer != NULL)
		*lpBuffer = _T('\0');
...
DWORD CIni::GetSectionNames(LPTSTR lpBuffer, DWORD dwBufSize)
{
	if (lpBuffer == NULL)
	{
		// just calculate the required buffer size
		DWORD dwLen = DEF_PROFILE_THRESHOLD;
		LPTSTR psz = new TCHAR[dwLen + 1];
		DWORD dwCopied = GetPrivateProfileSectionNames(psz, dwLen);
		while (dwCopied + 2 >= dwLen)
		{
			dwLen += DEF_PROFILE_THRESHOLD;
			delete [] psz;
			psz = new TCHAR[dwLen + 1];
			dwCopied = GetPrivateProfileSectionNames(psz, dwLen);
		}
	...
	{
		return GetPrivateProfileSectionNames(lpBuffer, dwBufSize);
	}
}

#ifdef __AFXWIN_H__
void CIni::GetSectionNames(CStringArray *pArray)
{
	if (pArray != NULL)
		pArray->RemoveAll();
...
#ifdef __AFXWIN_H__
// Retrieve a list of key-lines(key-pairs) of the specified section
void CIni::GetKeyLines(LPCTSTR lpSection, CStringArray *pArray)
{
	if (pArray != NULL)
		pArray->RemoveAll();
...
#ifdef __AFXWIN_H__
// Retrieve a list of key names of the specified section
void CIni::GetKeyNames(LPCTSTR lpSection, CStringArray *pArray)
{
	if (pArray == NULL)
		return;
...
BOOL CIni::DeleteSection(LPCTSTR lpSection)
{
	return WritePrivateProfileString(lpSection, NULL, _T(""));
}

// Remove a key from a section
BOOL CIni::DeleteKey(LPCTSTR lpSection, LPCTSTR lpKey)
{
	return WritePrivateProfileString(lpSection, lpKey, NULL);
}

BOOL CIni::IsSectionExist(LPCTSTR lpSection)
{
	if (lpSection == NULL)
		return FALSE;
...
BOOL CIni::IsKeyExist(LPCTSTR lpSection, LPCTSTR lpKey)
{
	if (lpSection == NULL || lpKey == NULL)
		return FALSE;
...
BOOL CIni::CopySection(LPCTSTR lpSrcSection, LPCTSTR lpDestSection, BOOL bFailIfExist)
{
	...
	const BOOL RES = WritePrivateProfileSection(lpDestSection, psz);
	delete [] psz;
...
BOOL CIni::MoveSection(LPCTSTR lpSrcSection, LPCTSTR lpDestSection, BOOL bFailIfExist)
{
	return CopySection(lpSrcSection, lpDestSection, bFailIfExist)
		&& DeleteSection(lpSrcSection);
}

BOOL CIni::MoveKey(LPCTSTR lpSrcSection, LPCTSTR lpSrcKey, LPCTSTR lpDestSection, LPCTSTR lpDestKey, BOOL bFailIfExist)
{
...
LPTSTR CIni::__GetStringDynamic(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpDefault)
{
	TCHAR* psz = NULL;
	if (lpSection == NULL || lpKey == NULL)
	{
	...
	DWORD dwLen = DEF_PROFILE_THRESHOLD;
	psz = new TCHAR[dwLen + 1];
	DWORD dwCopied = GetPrivateProfileString(lpSection, lpKey, lpDefault == NULL ? _T("") : lpDefault, psz, dwLen);
	while (dwCopied + 1 >= dwLen)
		{		
		dwLen += DEF_PROFILE_THRESHOLD;
		delete [] psz;
		psz = new TCHAR[dwLen + 1];
		dwCopied = GetPrivateProfileString(lpSection, lpKey, lpDefault == NULL ? _T("") : lpDefault, psz, dwLen);
		}
...
DWORD 
CIni::GetPrivateProfileSection(LPCSTR lpAppName, LPSTR lpReturnedString, DWORD nSize)
	{
	if( !m_pszPathNameW )
		return ::GetPrivateProfileSectionA(lpAppName, lpReturnedString, nSize, m_pszPathName);

	wchar_t* lpSectionW = NULL;
	wchar_t* lpValueW = new wchar_t[nSize + 1];
	
	DWORD dwRet = ::GetPrivateProfileSectionW(lpSectionW, lpValueW, nSize, m_pszPathNameW);

	StringWideToAnsi(lpValueW, lpReturnedString);
...
DWORD 
CIni::GetPrivateProfileSectionNames(LPSTR lpszReturnBuffer, DWORD nSize)
	{
	if( !m_pszPathNameW )
		return ::GetPrivateProfileSectionNamesA(lpszReturnBuffer, nSize, m_pszPathName);

	wchar_t* lpValueW = new wchar_t[nSize + 1];
	DWORD dwRet = ::GetPrivateProfileSectionNamesW(lpValueW, nSize, m_pszPathNameW);
	StringWideToAnsi(lpValueW, lpszReturnBuffer);
	delete lpValueW;
	return dwRet;
...
BOOL
CIni::WritePrivateProfileString(LPCSTR lpAppName, LPCSTR lpKeyName, LPCSTR lpString)
	{
	if( !m_pszPathNameW )
		return ::WritePrivateProfileStringA(lpAppName, lpKeyName, lpString, m_pszPathName);

	wchar_t* lpSectionW = NULL;
	wchar_t* lpKeyW = NULL;
	wchar_t* lpValueW = NULL;

	StringAnsiToWide(lpAppName, lpSectionW);
	StringAnsiToWide(lpKeyName, lpKeyW);
	StringAnsiToWide(lpString, lpValueW);

	BOOL bRet = ::WritePrivateProfileStringW(lpSectionW, lpKeyW, lpValueW, m_pszPathNameW);
...
BOOL
CIni::WritePrivateProfileSection(LPCSTR lpAppName, LPCSTR lpString)
	{
	if( !m_pszPathNameW )
		return ::WritePrivateProfileSectionA(lpAppName, lpString, m_pszPathName);
	...
	BOOL bRet = ::WritePrivateProfileSectionW(lpSectionW, lpValueW, m_pszPathNameW);
...
DWORD
CIni::GetPrivateProfileString(LPCSTR lpAppName, LPCSTR lpKeyName,
					    LPCSTR lpDefault, LPSTR lpReturnedString, DWORD nSize)
	{
	if( !m_pszPathNameW )
		return ::GetPrivateProfileStringA(lpAppName, lpKeyName, lpDefault, lpReturnedString, nSize, m_pszPathName);

	wchar_t* lpSectionW = NULL;
	wchar_t* lpKeyW = NULL;
	wchar_t* lpValueDefW = NULL;
	wchar_t* lpValueW = new wchar_t[nSize+1];

	StringAnsiToWide(lpAppName, lpSectionW);
	StringAnsiToWide(lpKeyName, lpKeyW);
	StringAnsiToWide(lpDefault, lpValueDefW);

	BOOL bRet = ::GetPrivateProfileStringW(lpSectionW, lpKeyW, lpValueDefW, lpValueW, nSize, m_pszPathNameW);
	StringWideToAnsi(lpValueW, lpReturnedString);
...
void 
CIni::StringAnsiToWide(CString sAnsi, wchar_t*& lpWide)
	{
	int nLen = sAnsi.GetLength();
	lpWide = new wchar_t[nLen+1];
	char* pszAnsi = (char*)sAnsi.GetBuffer();

	int nLoop = 0;
	while( pszAnsi[nLoop] != 0 )
		{
		lpWide[nLoop] = (wchar_t)(pszAnsi[nLoop]);
		nLoop ++;
		}
...
void
CIni::StringWideToAnsi(wchar_t* lpWide, char* sAnsi)
	{
	int nLen	= wcslen(lpWide);
	int nLoop	= 0;

	while(lpWide[nLoop] != 0){
		sAnsi[nLoop] = (char)(lpWide[nLoop]);
		nLoop ++;
		}
