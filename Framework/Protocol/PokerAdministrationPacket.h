...
public:
	...
	_String												m_sMessage;						// [IN] Message text.
...
public:
	...
	_String												m_sMessageDescription;		// [IN] Message description send to connected client and then drop connection.
...
public:
	...
	_String					m_sResponseLog;				// [OUT] Response log string.
	...
	_String					m_sName;					// [IN] Tournament name.
	_String					m_sDescription;				// [IN] Tournament description.
	...
	short					m_shOpenTableBeforeStartSec;// [IN] Open tables before start.
	...
	int						m_nPrizeTicketId;			// [IN] Prize ticket id. (tournament id of main tournament) (for satellite tournaments only)
	double					m_dTicketPriceAmount;		// [IN] Ticket price (For satellite tournament).
	short					m_shGuaranteedTicketCt;		// [IN] Guaranteed tickets count. (For satellite tournament)
	...
	bool					m_bAllowToUseVPPoints;		// [IN] Permission flag to use VPPoints.
	bool					m_bRestrictSameIPs;			// [IN] Restrict same ips registering in tournament.
