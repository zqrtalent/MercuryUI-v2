...
public: // Operations.
	...
	void					SetUserBalance		(INT_CHIPS nBalance, bool bRedraw);
	void					SetUserInPlayAmount	(INT_CHIPS nInPlayAmount, bool bRedraw);
	void					SetUserRank			(int nRank, bool bRedraw);
	void					SetUserAvatarImage	(Image* pImageAvatar, bool bRedraw);
