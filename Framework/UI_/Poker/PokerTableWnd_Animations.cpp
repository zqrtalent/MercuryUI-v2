...
DECLARE_VAR(_T("DealSeatCardsAnimationInfo"),				_T(""), VariableType::VT_None, 0, false, true, false)
	DECLARE_VAR(_T("MotionTypeX"),							_T(""), VariableType::VT_Int32, offsetof(DealSeatCardsAnimationInfo,m_nMotionTypeX), false, false, false)
	DECLARE_VAR(_T("MotionTypeY"),							_T(""), VariableType::VT_Int32, offsetof(DealSeatCardsAnimationInfo,m_nMotionTypeY), false, false, false)
	DECLARE_VAR(_T("MotionTimeMS"),							_T(""), VariableType::VT_Int32, offsetof(DealSeatCardsAnimationInfo,m_nMotionTimeMS), false, false, false)
	DECLARE_VAR(_T("TimeDistanceBetweenSeatCardAnimation"),	_T(""), VariableType::VT_Int32, offsetof(DealSeatCardsAnimationInfo,m_nTimeDistanceBetweenSeatCardAnimation), false, false, false)
	DECLARE_VAR(_T("TimeDistanceBetweenCardAnimation"),		_T(""), VariableType::VT_Int32, offsetof(DealSeatCardsAnimationInfo,m_nTimeDistanceBetweenCardAnimation), false, false, false)
	DECLARE_VAR(_T("FrameCtPerSecond"),						_T(""), VariableType::VT_Int32, offsetof(DealSeatCardsAnimationInfo,m_nFrameCtPerSecond), false, false, false)
	DECLARE_VAR(_T("AlphaAtStart"),							_T(""), VariableType::VT_Int8, offsetof(DealSeatCardsAnimationInfo,m_btAlphaAtStart), false, false, false)
END_DECLARE_VAR()
...
DECLARE_VAR(_T("TableCardsAnimationInfo"),					_T(""), VariableType::VT_None, 0, false, true, false)
	DECLARE_VAR(_T("MotionTypeX"),							_T(""), VariableType::VT_Int32, offsetof(TableCardsAnimationInfo,m_nMotionTypeX), false, false, false)
	DECLARE_VAR(_T("MotionTypeY"),							_T(""), VariableType::VT_Int32, offsetof(TableCardsAnimationInfo,m_nMotionTypeY), false, false, false)
	DECLARE_VAR(_T("MotionTimeMS"),							_T(""), VariableType::VT_Int32, offsetof(TableCardsAnimationInfo,m_nMotionTimeMS), false, false, false)
	DECLARE_VAR(_T("FlopCardsMotionTimeMS"),				_T(""), VariableType::VT_Int32, offsetof(TableCardsAnimationInfo,m_nFlopCardsMotionTimeMS), false, false, false)
	DECLARE_VAR(_T("TimeDistanceBetweenCardAnimation"),		_T(""), VariableType::VT_Int32, offsetof(TableCardsAnimationInfo,m_nTimeDistanceBetweenCardAnimation), false, false, false)
	DECLARE_VAR(_T("FrameCtPerSecond"),						_T(""), VariableType::VT_Int32, offsetof(TableCardsAnimationInfo,m_nFrameCtPerSecond), false, false, false)
	DECLARE_VAR(_T("AlphaAtStart"),							_T(""), VariableType::VT_Int8, offsetof(TableCardsAnimationInfo,m_btAlphaAtStart), false, false, false)
	DECLARE_VAR(_T("SlideCardsOnFLop"),						_T(""), VariableType::VT_Bool, offsetof(TableCardsAnimationInfo,m_bSlideCardsOnFLop), false, false, false)
END_DECLARE_VAR()
...
DECLARE_VAR(_T("CollectChipsAnimationInfo"),				_T(""), VariableType::VT_None, 0, false, true, false)
	DECLARE_VAR(_T("MotionTypeX"),							_T(""), VariableType::VT_Int32, offsetof(CollectChipsAnimationInfo,m_nMotionTypeX), false, false, false)
	DECLARE_VAR(_T("MotionTypeY"),							_T(""), VariableType::VT_Int32, offsetof(CollectChipsAnimationInfo,m_nMotionTypeY), false, false, false)
	DECLARE_VAR(_T("MotionTimeMS"),							_T(""), VariableType::VT_Int32, offsetof(CollectChipsAnimationInfo,m_nMotionTimeMS), false, false, false)
	DECLARE_VAR(_T("FrameCtPerSecond"),						_T(""), VariableType::VT_Int32, offsetof(CollectChipsAnimationInfo,m_nFrameCtPerSecond), false, false, false)
	DECLARE_VAR(_T("DelayAfterMotionMS"),					_T(""), VariableType::VT_Int32, offsetof(CollectChipsAnimationInfo,m_nDelayAfterMotionMS), false, false, false)
END_DECLARE_VAR()
...
DECLARE_VAR(_T("MoveChipsAnimationInfo"),					_T(""), VariableType::VT_None, 0, false, true, false)
	DECLARE_VAR(_T("MotionTypeX"),							_T(""), VariableType::VT_Int32, offsetof(MoveChipsAnimationInfo,m_nMotionTypeX), false, false, false)
	DECLARE_VAR(_T("MotionTypeY"),							_T(""), VariableType::VT_Int32, offsetof(MoveChipsAnimationInfo,m_nMotionTypeY), false, false, false)
	DECLARE_VAR(_T("MotionTimeMS"),							_T(""), VariableType::VT_Int32, offsetof(MoveChipsAnimationInfo,m_nMotionTimeMS), false, false, false)
	DECLARE_VAR(_T("FrameCtPerSecond"),						_T(""), VariableType::VT_Int32, offsetof(MoveChipsAnimationInfo,m_nFrameCtPerSecond), false, false, false)
END_DECLARE_VAR()
...
bool
PokerTableWnd::CollectChips(INT_CHIPS nMainChipsAmount, EnumerableObject<PokerPotAmountDetail>* pListPots){
	...
	_Rect					rcMainChips			= pMainChips->GetClientRect();
	...
	for(int i=0; i<m_info.m_seats.GetCount(); i++){
		...
		_Rect					rcControl	= pChip->GetClientRect();
...
PokerTableWnd::MoveChipsFromPot(List<PokerHandWinnerInfo>* pListWinners, bool bUseDelayBeforeAnimation){	
	...
	for(int i=0; i<pListWinnersCopy->GetCount(); i++){
		...
		for(char j=0; j<pInfo->m_listWonAmountDetail.GetCount(); j++){
			...
			_Rect					rcSidePotChips	= pSidePotChips->GetClientRect();
			_Rect					rcControl		= pChip->GetClientRect();
	...
	for(int j=0; j<nCardsCtForEachSeat; j++){
		...
		for(int i=0; i<arrHandCardsByOrder.GetCount(); i++){
			...
			if( !pHiddenCards || nArrCards[j] > -1 ){
				...
				if( pSeatCards ){
	//				_Point ptCard = pSeatCards->GetCardPointByIndex(j);
					_Point ptCard = pSeatCards->GetCardCenterByIndex(j);
					if( ptCard != _Point(0, 0) ){
...
PokerTableWnd::DealTableCardsAnimation(PokerRoundStartedPacket* p){
	if( !p ) return false;
	_Rect rcClient, rcCard;
	GetClientRectMy(rcClient);

	ESChildControlTableCards*	pTableCards		= GetTableCardsControl();
	ESChildControlTable*		pTable			= GetTableControl();
	_Rect						rcControl		= pTableCards->GetClientRect();
	ESChildControlSeatHiddenCards*	pDeck		= GetDeckControl();
	...
	_Size						szCard			= pTableCards->GetCardDefaultSize();
	...
	switch( ((int)p->m_cRoundType) ){
		...
		case PokerRoundType::Turn:{
			_Rect	rcCard4	= pTableCards->GetCardRect(3);
		...
		case PokerRoundType::River:{
			_Rect	rcCard5	= pTableCards->GetCardRect(4);
			fSizeStartCX	= pDeck->GetLogicalPosX();
			fSizeStartCY	= pDeck->GetLogicalPosY();
...
bool
PokerTableWnd::AnimationWillBeVisible(const _Rect rcAnimateArea){
	...
	_Rect rcAnimateAreaScreen = rcAnimateArea, rcWindow;
...
void
PokerTableWnd::OnTableFlopCardDealMotionEnd(ESChildControlSeatHiddenCards* pSender, ChildControlEventCode eventCode, void* lpParam){
	int nParam			= (int)lpParam;
	...
	if( cCardIndex == 2 ){// Open flop cards.
		...
		// Redraw table cards. {{
		ESChildControlTableCards*	pTableCards		= GetTableCardsControl();
		_Rect rcRedrawTableCards, rcCard;
		...
		ESChildControlTableCards*	pTableCards		= GetTableCardsControl();
		_Rect rcCard = pTableCards->GetCardRect(cCardIndex);
		RedrawRect(rcCard, 0);
		}
...
void
PokerTableWnd::OnTableFlopCardDealMotionStop(ESChildControlSeatHiddenCards* pSender, ChildControlEventCode eventCode, void* lpParam){
	// Destroy motion card control.
	RemoveChildControl(pSender);
	}

void
PokerTableWnd::OnSeatCardDealMotionEnd(ESChildControlSeatHiddenCards* pSender, ChildControlEventCode eventCode, void* lpParam){
	if( m_pHandler )
		m_pHandler->OnSeatCardDealMotionEnd(pSender);
	}

void
PokerTableWnd::OnSeatCardDealMotionStop(ESChildControlSeatHiddenCards* pSender, ChildControlEventCode eventCode, void* lpParam){
	}

void
PokerTableWnd::OnMoveChipsMotionStart(ESChildControlChips* pSender, ChildControlEventCode eventCode, void* lpParam){
	// Pot index 0 is main pot index.
	int nPotIndex = (int)lpParam;
	if( !nPotIndex ){
		// Call event handler.
...
void
PokerTableWnd::OnMoveChipsMotionEnd(ESChildControlChips* pSender, ChildControlEventCode eventCode, void* lpParam){
	struct MoveChipsMotionEndParam{
		int						nSeatIndex;
		int						nPotAmountToSet;
		};
	MoveChipsMotionEndParam* pParam = (MoveChipsMotionEndParam*)lpParam;
...
void
PokerTableWnd::OnMoveChipsMotionStop(ESChildControlChips* pSender, ChildControlEventCode eventCode, void* lpParam){
	// Destroy motion chip control.
	RemoveChildControl(pSender);
	}

void
PokerTableWnd::OnCollectChipsMotionStart(ESChildControlChips* pSender, ChildControlEventCode eventCode, void* lpParam){
	// Update seat chip amount. {{
	int nChipSeatIndex = (int)lpParam;
...
void
PokerTableWnd::OnCollectChipsMotionEnd(ESChildControlChips* pSender, ChildControlEventCode eventCode, void* lpParam){
	}

void
PokerTableWnd::OnCollectChipsMotionStop(ESChildControlChips* pSender, ChildControlEventCode eventCode, void* lpParam){
	// Destroy motion chip control.
	RemoveChildControl(pSender);
	}
