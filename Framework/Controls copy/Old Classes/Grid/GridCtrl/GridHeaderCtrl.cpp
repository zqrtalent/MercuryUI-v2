...
IMPLEMENT_DYNCREATE(CGridHeaderCtrl, CHeaderCtrl)
...
// ModifyProperty
BOOL 
CGridHeaderCtrl::ModifyProperty(WPARAM wParam, LPARAM lParam)
	{
	switch( wParam )
		{
...
// DrawCtrl
void 
CGridHeaderCtrl::DrawCtrl(CDC* pDC)
	{
	CRect rectClip;
...
// DrawItem
void 
CGridHeaderCtrl::DrawItem(LPDRAWITEMSTRUCT)
	{
...
// DrawItem
void 
CGridHeaderCtrl::DrawItem(CDC* pDC, CRect rect, LPHDITEM lphdi)
	{
...
// DrawImage
int 
CGridHeaderCtrl::DrawImage(CDC* pDC, CRect rect, LPHDITEM lphdi, BOOL bRight)
	{
...
// DrawBitmap
int 
CGridHeaderCtrl::DrawBitmap(CDC*		pDC, 
							CRect		rect, 
							LPHDITEM	lphdi, 
							CBitmap*	pBitmap, 
							BITMAP*		pBitmapInfo, 
...
// DrawText
int 
CGridHeaderCtrl::DrawText(CDC* pDC, CRect rect, LPHDITEM lphdi)
	{
	CSize size;
...
// OnInsertItem
LRESULT 
CGridHeaderCtrl::OnInsertItem(WPARAM, LPARAM)
	{
	return Default();
	}
...
// OnDeleteItem
LRESULT 
CGridHeaderCtrl::OnDeleteItem(WPARAM, LPARAM)
	{
	return Default();
	}
...
// OnSetImageList
LRESULT 
CGridHeaderCtrl::OnSetImageList(WPARAM, LPARAM lParam)
	{
...
// OnLayout
LRESULT 
CGridHeaderCtrl::OnLayout(WPARAM, LPARAM lParam)
	{
...
// OnSysColorChange
void 
CGridHeaderCtrl::OnSysColorChange() 
	{
	TRACE(_T("in CGridHeaderCtrl::OnSysColorChange\n"));
...
// OnEraseBkgnd
BOOL 
CGridHeaderCtrl::OnEraseBkgnd(CDC* pDC) 
	{
	UNUSED_ALWAYS(pDC);
	return TRUE;
	}
