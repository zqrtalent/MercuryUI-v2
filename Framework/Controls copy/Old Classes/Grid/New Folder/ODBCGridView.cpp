...
//
bool
ODBCGridView::OnDrawCellIcon(IN int Row, IN int Col,
...
//
//	ODBCGridView::AdjustBrightness
//
void 
ODBCGridView::AdjustBrightness(	IN OUT COLORREF&	Color,
