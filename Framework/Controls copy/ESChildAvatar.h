...
public:
	...
	bool				SetAvatarImage			(_Image* pImage, bool bRedraw = true);
...
protected:
	...
	_Image				m_imageAvatarBorder;			// Border image.
	_Image				m_imageAvatarBg;				// Avatar bg image.
	_Image				m_imageAvatar;					// Avatar image.

	_Image*				m_pImageAvatarBorder;
	_Image*				m_pImageAvatarBg;
	_Image*				m_pImageAvatar;
