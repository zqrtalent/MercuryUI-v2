...
protected:
	// UI parameters. {{
	_Image			m_imageSliderBarFilled;
	_Rect			m_rcOmitBarFilled;
	_Image			m_imageSliderBarNotFilled;
	_Rect			m_rcOmitBarNotFilled;

	_Image			m_imageSliderBarFilled_Scale;
	_Rect			m_rcOmitBarFilled_Scale;
	_Image			m_imageSliderBarNotFilled_Scale;
	_Rect			m_rcOmitBarNotFilled_Scale;

	_Image			m_imageCursor;
	_Image			m_imageCursorPushed;
	_Image			m_imagePlusButtonNormal;
	_Image			m_imagePlusButtonPushed;
	_Image			m_imageMinusButtonNormal;
	_Image			m_imageMinusButtonPushed;
