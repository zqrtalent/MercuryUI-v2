...
protected:
	...
	_Image*			GetImageByState					(DWORD dwState);
...
protected:
	_Image				m_imageNormal;
	_Image				m_imageHover;
	_Image				m_imagePushed;
	_Image				m_imageDisabled;
	...
	_Image				*m_pImageNormalDef;
	_Image				*m_pImageHoverDef;
	_Image				*m_pImagePushedDef;
	_Image				*m_pImageDisabledDef;
	DWORD				m_dwState;
