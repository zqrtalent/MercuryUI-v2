...
public:
	...
	// Image instances.
	_Image*					m_pImageDefault;
	_Image*					m_pImageHover;
	_Image*					m_pImagePressed;

	_Image*					m_pImageActiveDefault;
	_Image*					m_pImageActiveHover;
	_Image*					m_pImageActivePressed;
...
protected:
	...
	// Custom item images. {{
	_Image								m_imgItemNormal;
	_Image								m_imgItemHover;
	_Image								m_imgItemActive;
	// }}
	...
	_Image*								m_pImageItemNormal;
	_Image*								m_pImageItemHover;
	_Image*								m_pImageItemActive;

	_Rect								m_rcItemOmitBorder;
	_Font								m_tabItemFont;
	_Font								m_tabItemActiveFont;
