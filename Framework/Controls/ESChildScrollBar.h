...
protected:
	...
	_Image*				m_pImageVScrollThumb;
	_Image*				m_pImageVScrollArrowBottomSel;
	_Image*				m_pImageVScrollArrowBottomNormal;
	_Image*				m_pImageVScrollMiddle;
	_Image*				m_pImageVScrollArrowTopSel;
	_Image*				m_pImageVScrollArrowTopNormal;
	_Rect				m_rcVThumbOmitBorder;

	_Image*				m_pImageHScrollThumb;
	_Image*				m_pImageHScrollArrowRightSel;
	_Image*				m_pImageHScrollArrowRightNormal;
	_Image*				m_pImageHScrollMiddle;
	_Image*				m_pImageHScrollArrowLeftSel;
	_Image*				m_pImageHScrollArrowLeftNormal;
	_Rect				m_rcHThumbOmitBorder;

	_Image*				m_pImageDivider;
