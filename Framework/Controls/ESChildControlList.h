...
protected:
	...
	int									m_nHeaderCY;
	_Image								m_imgHeaderDefault;
	_Image*								m_pHdrItemDefault;
	_Image*								m_pHdrItemSelected;
	_Image*								m_pHdrItemDivider;

	_Font								m_normalItemTextFont;
	_Font								m_selectedItemTextFont;
	_Font								m_headerTextFont;
