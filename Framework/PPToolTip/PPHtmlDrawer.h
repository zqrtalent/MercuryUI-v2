...
//		2004/12/05	[CHN] Replaces ImageList to HIMAGELIST
//					[CHN] Replaces MFC classes (_Size, _Point, _Rect) to API structures
...
#ifdef _MFC_VER
	#define CPPString	_String //MFC program
#else
	#include "StdString.h"
	#ifdef _UNICODE
...
#pragma pack(1)
	typedef struct _STRUCT_CHANGESTYLE 
	{
		...
		BOOL bItaliFont;	//Is italic logic font?
