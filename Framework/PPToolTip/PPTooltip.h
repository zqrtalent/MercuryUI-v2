...
// Comments a next line if you never use a tooltip for a menu
...
typedef struct tagPPTOOLTIP_INFO
{
	...
	_String		sTooltip;		// The string of the tooltip
	UINT        nMask;			// The mask 
...
protected:
	...
	bool m_bActive; // Tooltip active state.
...
//	void AddToolBar(CToolBar * pBar);
	...
	void AddTool(CWnd * pWnd, DWORD dwIdString, DWORD dwIdIcon, _Size & szIcon = _Size(0, 0), LPCRECT lpRectBounds = NULL, DWORD dwIDTool = 0);
	void AddTool(CWnd * pWnd, LPCTSTR lpszString, HICON hIcon, LPCRECT lpRectBounds = NULL, DWORD dwIDTool = 0);
	void AddTool(CWnd * pWnd, LPCTSTR lpszString, DWORD dwIdIcon, _Size & szIcon = _Size(0, 0), LPCRECT lpRectBounds = NULL, DWORD dwIDTool = 0);
	void AddTool(CWnd * pWnd, LPCTSTR lpszString, DWORD dwIdBitmap, COLORREF crMask, _Size & szBitmap = _Size(0, 0), LPCRECT lpRectBounds = NULL, DWORD dwIDTool = 0);
	...
	void ShowHelpTooltip (LPPOINT pt, DWORD dwIdText, DWORD dwIdIcon, _Size & szIcon = _Size(0, 0));
	void ShowHelpTooltip (LPPOINT pt, LPCTSTR lpszString, HICON hIcon = NULL);
	void ShowHelpTooltip (LPPOINT pt, LPCTSTR lpszString, DWORD dwIdIcon, _Size & szIcon = _Size(0, 0));
...
protected:
	...
	void FreeResources();
	_String GetDebugInfoTool(LPPOINT lpPoint);
	...
	_String GetMaxDebugString(LPCTSTR lpszText);
	_String CreateDebugCell(_String sTitle, LPCTSTR lpszDescription);
