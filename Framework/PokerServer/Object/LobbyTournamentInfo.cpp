...
LobbyTournamentInfo::LobbyTournamentInfo(){
	...
	m_listParticipants	.CreateVariableIndex(_T("Order"),	Serializable::Compare_Int64_Desc);
//	m_listParticipants	.CreateVariableIndex(_T("Chips"), (CompareProc)Serializable::Compare_Int64_Desc);
	// }}
	}
...
BEGIN_DECLARE_VAR(LobbyTournamentInfo, Serializable)
	...
	DECLARE_VAR(_T("RegistrationIsOpen"),		_T(""),	VariableType::VT_Bool, offsetof(LobbyTournamentInfo,m_bRegistrationIsOpen), false, false, false)
	DECLARE_VAR(_T("AllowedToUseVPPoints"),		_T(""),	VariableType::VT_Bool, offsetof(LobbyTournamentInfo,m_bAllowedToUseVPPoints), false, false, false)
	...
	DECLARE_VAR(_T("SatelliteToId"),			_T(""),	VariableType::VT_Int32, offsetof(LobbyTournamentInfo,m_nSatelliteToId), false, false, false)
	DECLARE_VAR(_T("SatelliteToName"),			_T(""),	VariableType::VT_String, offsetof(LobbyTournamentInfo,m_sSatelliteToName), false, false, false)
	DECLARE_VAR(_T("SatelliteToStart"),			_T(""),	VariableType::VT_DateTime, offsetof(LobbyTournamentInfo,m_dtSatelliteToStart), false, false, false)
...
bool
LobbyTournamentInfo::SetParticipantChipsAmountAndPlace(int nUserId, INT_CHIPS nChipsAmount, int nPlace /*= -1*/){
	...
	//TRACE(_T("Thread=%d SetParticipantChipsAmountAndPlace UserId=%d nChipsAmount=%d nPlace=%d\r\n"), GetCurrentThreadId(), nUserId, nChipsAmount, nPlace);

	INT_CHIPS	nOrder = nChipsAmount;
	// Need to make an right order of tournament players by rank and chips amount.
	if( nPlace > 0 && !nChipsAmount )
		nOrder = (-1 * nPlace);

	if( pParticipant->m_nOrder == nOrder ) {
		//m_lock.Unlock();
		return true;
		}
...
BEGIN_DECLARE_VAR(LobbyTournamentDynamicInfo, Serializable)
	...
	DECLARE_VAR(_T("RegistrationIsOpen"),				_T(""),	VariableType::VT_Bool, offsetof(LobbyTournamentDynamicInfo,m_bRegistrationIsOpen), false, false, false)
	...
	DECLARE_VAR(_T("PrizePool"),						_T(""),	VariableType::VT_Int32, offsetof(LobbyTournamentDynamicInfo,m_nPrizePool), false, false, false)
	DECLARE_VAR(_T("AllRebuysCt"),						_T(""),	VariableType::VT_Int32, offsetof(LobbyTournamentDynamicInfo,m_nAllRebuysCt), false, false, false)
	DECLARE_VAR(_T("AllAddonsCt"),						_T(""),	VariableType::VT_Int32, offsetof(LobbyTournamentDynamicInfo,m_nAllAddonsCt), false, false, false)
END_DECLARE_VAR()
...
BEGIN_DECLARE_VAR(TournamentPlayerInfo, Serializable)
	...
	DECLARE_VAR(_T("Chips"),				_T(""),	VariableType::VT_Chips, offsetof(TournamentPlayerInfo,m_nChips), false, false, false)
	DECLARE_VAR(_T("Place"),				_T(""),	VariableType::VT_Int16, offsetof(TournamentPlayerInfo,m_shPlace), false, false, false)
	DECLARE_VAR(_T("Order"),				_T(""),	VariableType::VT_Chips, offsetof(TournamentPlayerInfo,m_nOrder), false, false, false)
END_DECLARE_VAR()
...
BEGIN_DECLARE_VAR(TournamentTableInfo, Serializable)
	...
	DECLARE_VAR(_T("StakeLarge"),				_T(""),	VariableType::VT_Chips, offsetof(TournamentTableInfo,m_nStakeLarge), false, false, false)
	DECLARE_VAR(_T("StakeSmall"),				_T(""),	VariableType::VT_Chips, offsetof(TournamentTableInfo,m_nStakeSmall), false, false, false)
