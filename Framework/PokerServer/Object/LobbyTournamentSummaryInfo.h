...
public:
	...
	UINT												m_nLargestStake;			// Largest stake.
	UINT												m_nAverageStake;			// Average stake.
	UINT												m_nSmallestStake;			// Smallest stake.

	//Tournament info.
	EnumerableObject<LobbyTournamentInfo>				m_listInfo;
