...
protected:
	...
	CImage			m_imageCharacters;	// Characters map image.
	CPoint*			m_pCharPoints;		// x is left offset, y is width of character.
...
protected:
	...
	bool					GetSymbolRectFromImage		(EmbedeedFontItemInfo* pItem, int nSymbolCode, CRect& rcSymbol);
